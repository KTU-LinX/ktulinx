                ...
                SafeArea(
                  ...
                  sel = value;
                              ...
                              Expanded(
                                  child: Row(
                                children: <Widget>[
                                  Expanded(child: Text("1ST YEAR",style: TextStyle(color: Colors.red),)),
                                  SizedBox(
                                    width: 20,
                                  ),
                                  Expanded(
                                    child:
                                    TextField(
                                      decoration: InputDecoration(hintText: "S1",hintStyle:TextStyle(color: Colors.white,backgroundColor: Colors.white),),
                                      onChanged: (String z) {
                  setState(() {
